...
| ブロック           | US-01 の例（2026-08-28 時点）                                                                     |
| ------------------ | ------------------------------------------------------------------------------------------------- |
| 機能スプリント     | 実装・ローカル確認まで済。PR は未 merge。Vitest は ADR-009 どおり本番確認前に薄く入れる（未導入） |
| リリーススプリント | 未着手（ホスト未定・本番 HTTPS 総合・[releases/US-01.md](./releases/US-01.md)・GitHub Release）   |
| サイクル末尾       | 振り返り（3見出し）・計画ファイルへの引き継ぎは未                                                 |
