...
| ブロック           | US-01 の例（2026-09-08 時点）                                                                                                            |
| ------------------ | ---------------------------------------------------------------------------------------------------------------------------------------- |
| 機能スプリント     | 完了。[PR #1](https://github.com/HaraRyonosuke/condition-tracker/pull/1) を merge（`4a95dd7`）。機能振り返り済み                         |
| リリーススプリント | ホストは GitHub Pages（[ADR-011](./adr/011-hosting.md)）。本番 HTTPS 総合・[releases/US-01.md](./releases/US-01.md)・GitHub Release は未 |
| サイクル末尾       | 3見出しの振り返りはリリースノートのあと。計画末尾の機能振り返りとリリース用引き継ぎは 2026-09-08 済み                                    |
