...
| 段階             | やること                                                               | 置き場                                                                                                         |
| ---------------- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------- |
| 本番環境への導入 | 利用者が触る HTTPS の公開面へ出す                                      | Vercel（[ADR-013](./adr/013-vercel-static-hosting.md)）。ビルドは Actions                                      |
...
残る関心は主に GitHub（公開リポジトリに秘密を置かない。デプロイトークンは Secrets）とホスティング（Vercel の HTTPS。ヘッダーは [ADR-013](./adr/013-vercel-static-hosting.md)）である。設定を足すときは、その画面の意味を説明してから書く。
